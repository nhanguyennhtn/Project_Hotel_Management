                        ...
                        <div className='row'>
                            <div className='col-12 text-center mt-4'>
                                ...
                                <div className='fw-bold fs-6 mb-3'>
                                    <input required {...registerCreate('topic')} placeholder="Nhập tên hợp đồng" />
                                </div>
                            </div>
                            <div className='container-body'>
                                ...
                                <div className=' mt-2 fw-600'>
                                    ...
                                    <p>Ông/bà (tên chủ hợp đồng) <input {...registerCreate('host')} placeholder='Họ và tên chủ trọ' className="p-100" /></p>
                                    <p>CMND/CCCD số  <input {...registerCreate('phoneHost')} placeholder='Số điện thoại của chủ trọ' /></p>
                                ...
                                <div className=''>
                                    ...
                                    <p>Bên A cho Bên B thuê 01 phòng trọ <input defaultValue={registerUser.room.title} />
                                        Với thời hạn là: <input required {...registerCreate('cycle')} placeholder='Hạn thuê phòng' />
                                ...
                                <div className='row text-center mt-4'>
                                    <div className='col-6'>
                                        ...
                                        <p className='mt-4'><input required {...registerCreate('signatureB')} placeholder="ghi gõ họ tên" /></p>
                                    </div>
                                    <div className='col-6'>
                                        <p className='info-user'>Bên A</p>
                                        <p>(Ký, ghi rõ họ tên)</p>
                                        <p className='mt-4'><input required {...registerCreate('signatureA')} placeholder="ghi gõ họ tên" /></p>
                                    </div>
                                </div>
                                <div className='row'>
